...
export declare const Selectors: {
    readonly chat: {
        readonly answerContainer: ".to-user-container";
        readonly answerText: ".to-user-container .message-text-content";
        readonly latestAnswerText: ".to-user-container:last-child .message-text-content";
        /**
         ...
         */
        readonly queryInput: readonly ["textarea.query-box-input", "textarea[aria-label*=\"query\" i]", "textarea[aria-label*=\"anfrag\" i]", "textarea[aria-label*=\"requete\" i]", "textarea[aria-label*=\"zone de requete\" i]", "textarea[aria-label*=\"consulta\" i]", "textarea[aria-label*=\"domanda\" i]", "textarea[aria-label*=\"vraag\" i]", "textarea[aria-label*=\"質問\" i]", "textarea[aria-label*=\"pergunta\" i]"];
        /**
         ...
         */
        readonly submitButton: readonly ["button.submit-button", "button.submit-button[aria-label*=\"send\" i]", "button.submit-button[aria-label*=\"senden\" i]", "button.submit-button[aria-label*=\"envoyer\" i]", "button.submit-button[aria-label*=\"enviar\" i]", "button.submit-button[aria-label*=\"invia\" i]", "button.submit-button[aria-label*=\"verzend\" i]", "button.submit-button[aria-label*=\"送信\" i]"];
    };
    /**
     ...
     */
    readonly tabs: {
        readonly discussion: readonly ["[role=\"tab\"]:has-text(\"Discussion\")", "[role=\"tab\"]:has-text(\"Diskussion\")", "[role=\"tab\"]:has-text(\"Diskussionen\")", "[role=\"tab\"]:has-text(\"Discusión\")", "[role=\"tab\"]:has-text(\"Discussione\")", "[role=\"tab\"]:has-text(\"Discussão\")", "[role=\"tab\"]:has-text(\"ディスカッション\")"];
        readonly sources: readonly ["[role=\"tab\"]:has-text(\"Sources\")", "[role=\"tab\"]:has-text(\"Quellen\")", "[role=\"tab\"]:has-text(\"Fuentes\")", "[role=\"tab\"]:has-text(\"Fonti\")", "[role=\"tab\"]:has-text(\"Fontes\")", "[role=\"tab\"]:has-text(\"Bronnen\")", "[role=\"tab\"]:has-text(\"ソース\")"];
        readonly activeTabClass: "mdc-tab--active";
        readonly tabList: ".mat-mdc-tab-list .mdc-tab";
    };
    readonly citations: {
        readonly button: readonly ["button.citation-marker", "button.xap-inline-dialog.citation-marker", "button[data-citation]"];
        readonly label: "span[aria-label]";
        readonly highlight: ".highlighted";
        readonly paragraph: ".paragraph";
        readonly paragraphHighlight: ".paragraph .highlighted";
    };
    readonly sources: {
        /**
         ...
         */
        readonly sourceContainer: ".single-source-container";
        /**
         ...
         */
        readonly sourceCountIndicator: ".cover-subtitle-source-count";
        /**
         ...
         */
        readonly addButton: readonly ["button.add-source-button", "button[aria-label=\"Add source\"]", "button[aria-label*=\"add source\" i]", "button[aria-label*=\"quelle hinzu\" i]", "button[aria-label*=\"ajouter une source\" i]", "button[aria-label*=\"añadir fuente\" i]", "button[aria-label*=\"agregar fuente\" i]", "button[aria-label*=\"aggiungi fonte\" i]", "button[aria-label*=\"adicionar fonte\" i]", "button[aria-label*=\"bron toevoegen\" i]", "button[aria-label*=\"ソースを追加\" i]"];
        /**
         ...
         */
        readonly overlayPane: "[role=\"dialog\"]";
        readonly overlayInput: "[role=\"dialog\"] input[type=\"text\"]:not([readonly])";
        readonly overlayTextarea: "[role=\"dialog\"] textarea";
        /**
    ...
    readonly studio: {
         ...
         */
        readonly audioOverviewButton: readonly [".create-artifact-button-container:has(mat-icon:text-is(\"audio_magic_eraser\"))", "[role=\"button\"]:has(mat-icon:text-is(\"audio_magic_eraser\"))", "[role=\"button\"][aria-label*=\"audio-zusammenfassung\" i]", "[role=\"button\"][aria-label*=\"audio overview\" i]", "[role=\"button\"][aria-label*=\"aperçu audio\" i]", "[role=\"button\"][aria-label*=\"resumen de audio\" i]", "[role=\"button\"][aria-label*=\"panoramica audio\" i]", "[role=\"button\"][aria-label*=\"visão geral de áudio\" i]", "[role=\"button\"][aria-label*=\"audio-overzicht\" i]", "[role=\"button\"][aria-label*=\"音声の概要\" i]", "[role=\"button\"][aria-label*=\"audio\" i]", "button:has(mat-icon:text-is(\"audio_magic_eraser\"))", "button[aria-label*=\"audio overview\" i]", "button[aria-label*=\"audio-zusammenfassung\" i]", "button[aria-label*=\"podcast\" i]"];
        /**
         * Generate / Generieren / Générer trigger inside the customise dialog.
         * Visible-text varies by locale.
         */
        readonly generateButton: readonly ["button:has-text(\"Generate\")", "button:has-text(\"Generieren\")", "button:has-text(\"Générer\")", "button:has-text(\"Generer\")", "button:has-text(\"Generar\")", "button:has-text(\"Genera\")", "button:has-text(\"Gerar\")", "button:has-text(\"Genereren\")", "button:has-text(\"生成\")"];
        /**
         ...
         */
        readonly downloadButton: readonly ["button:has(mat-icon:text-is(\"download\"))", "button[aria-label*=\"download\" i]", "button[aria-label*=\"herunterladen\" i]", "button[aria-label*=\"télécharger\" i]", "button[aria-label*=\"descargar\" i]", "button[aria-label*=\"scarica\" i]", "button[aria-label*=\"baixar\" i]", "button[aria-label*=\"downloaden\" i]", "button[aria-label*=\"ダウンロード\" i]"];
        /**
         ...
         */
        readonly audioPlayer: readonly ["artifact-library-item:has(button.artifact-action-button)", ".artifact-library-container artifact-library-item", "audio", "[role=\"audio\"]"];
        /**
         * Per-tile "Mehr"/"More"/"Plus"/… three-dot button. Opens the menu that
         * contains the Download item.
         */
        readonly audioMoreMenuButton: readonly ["artifact-library-item button:has(mat-icon:text-is(\"more_vert\"))", "artifact-library-item button[aria-label*=\"mehr\" i]", "artifact-library-item button[aria-label*=\"more\" i]", "artifact-library-item button[aria-label*=\"plus\" i]", "artifact-library-item button[aria-label*=\"más\" i]", "artifact-library-item button[aria-label*=\"altro\" i]", "artifact-library-item button[aria-label*=\"mais\" i]", "artifact-library-item button[aria-label*=\"meer\" i]", "artifact-library-item button[aria-label*=\"その他\" i]"];
        /**
         * Download menu-item that surfaces after clicking the three-dot menu.
         */
        readonly audioDownloadMenuItem: readonly ["[role=\"menuitem\"]:has(mat-icon:text-is(\"download\"))", "[role=\"menuitem\"]:has-text(\"Download\")", "[role=\"menuitem\"]:has-text(\"Herunterladen\")", "[role=\"menuitem\"]:has-text(\"Télécharger\")", "[role=\"menuitem\"]:has-text(\"Descargar\")", "[role=\"menuitem\"]:has-text(\"Scarica\")", "[role=\"menuitem\"]:has-text(\"Baixar\")", "[role=\"menuitem\"]:has-text(\"Downloaden\")", "[role=\"menuitem\"]:has-text(\"ダウンロード\")"];
    };
    readonly notebooks: {
        readonly projectCard: "button[aria-labelledby*=\"project-\"]";
        readonly cardMenuButton: readonly ["button[aria-label*=\"menu\" i]", "button[aria-label*=\"options\" i]", "button[aria-label*=\"more\" i]", "button[aria-label*=\"optionen\" i]", "button[aria-label*=\"opzioni\" i]", "button[aria-label*=\"opciones\" i]", "button[aria-label*=\"opções\" i]", "button[aria-label*=\"メニュー\" i]"];
        readonly deleteButton: readonly ["[role=\"menuitem\"]:has-text(\"Delete\")", "[role=\"menuitem\"]:has-text(\"Löschen\")", "[role=\"menuitem\"]:has-text(\"Supprimer\")", "[role=\"menuitem\"]:has-text(\"Eliminar\")", "[role=\"menuitem\"]:has-text(\"Borrar\")", "[role=\"menuitem\"]:has-text(\"Elimina\")", "[role=\"menuitem\"]:has-text(\"Excluir\")", "[role=\"menuitem\"]:has-text(\"Verwijderen\")", "[role=\"menuitem\"]:has-text(\"削除\")"];
        readonly confirmDelete: readonly ["button:has-text(\"Delete\")", "button:has-text(\"Löschen\")", "button:has-text(\"Supprimer\")", "button:has-text(\"Eliminar\")", "button:has-text(\"Borrar\")", "button:has-text(\"Elimina\")", "button:has-text(\"Excluir\")", "button:has-text(\"Verwijderen\")", "button:has-text(\"削除\")"];
    };
    /**
     ...
     */
    readonly uiControlLabels: Set<string>;
};
/**
 ...
 */
export declare function joinAlt(selectors: readonly string[]): string;
