 ...
 */
export async function snapshotPriorAnswers(page) {
    return page
 ...
 */
export async function waitForStableAnswer(page, options = {}) {
    const { question = "", timeoutMs = 600_000, pollIntervalMs = 750, ignoreTexts = [], stablePolls = 3, } = options;
...
export function sanitizeAnswer(text) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (!line)
            continue;
        if (Selectors.uiControlLabels.has(line))
            continue;
