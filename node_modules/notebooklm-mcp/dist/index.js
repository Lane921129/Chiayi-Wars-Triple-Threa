 ...
 */
function extractProgressToken(args) {
...
class NotebookLMMCPServer {
            ...
            try {
                ...
                switch (name) {
                    ...
                    case "cleanup_data":
                        ...
                        break;
                    case "add_source":
                        result = await this.toolHandlers.handleAddSource(args);
                        break;
                    case "generate_audio":
                        result = await this.toolHandlers.handleGenerateAudio(args);
                        break;
                    case "get_audio_status":
                        result = await this.toolHandlers.handleGetAudioStatus(args);
                        break;
                    case "download_audio":
                        result = await this.toolHandlers.handleDownloadAudio(args);
                        break;
                    default:
     ...
     */
    async start(options = { kind: "stdio" }) {
...
function parseTransportOptions(argv) {
    let kind = "stdio";
    let port = 3000;
    let host;
