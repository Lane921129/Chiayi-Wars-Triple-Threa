...
import { extractCitations as extractCitationsFromPage, } from "../notebooklm/citations.js";
import { addSource as addSourceToPage, } from "../notebooklm/sources.js";
import { generateAudioOverview as generateAudioOnPage, downloadAudioOverview as downloadAudioOnPage, getAudioStatusOnPage, } from "../notebooklm/audio.js";
...
export class BrowserSession {
     ...
     */
    async downloadAudio(destinationDir) {
        if (!this.initialized || !this.page || this.isPageClosedSafe()) {
            await this.init();
        }
     ...
     */
    async extractCitations(answer, format) {
