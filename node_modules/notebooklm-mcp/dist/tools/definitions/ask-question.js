...
export const askQuestionTool = {
    ...
    inputSchema: {
        ...
        properties: {
            question: {
                type: "string",
                description: "The question to ask NotebookLM. Plain natural language; can be " +
                    "multi-line. Gemini responds grounded on the notebook's sources.",
            },
            session_id: {
                type: "string",
                description: "Reuse an existing browser session for follow-up questions. " +
            ...
            source_format: {
                ...
                description: "How citations are returned alongside the answer:\n" +
