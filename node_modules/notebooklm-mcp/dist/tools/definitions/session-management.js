...
export const sessionManagementTools = [
    {
        name: "list_sessions",
        description: "List all active browser sessions for this server. Each entry includes " +
    ...
    {
        name: "close_session",
        description: "Permanently close a session and discard its browser tab. Use the " +
        ...
        inputSchema: {
            ...
            properties: {
                session_id: {
                    type: "string",
                    description: "Session id to close. Obtain from `list_sessions` or from any " +
    ...
    {
        name: "reset_session",
        description: "Clear a session's chat history while keeping the same session id. " +
        ...
        inputSchema: {
            ...
            properties: {
                session_id: {
                    type: "string",
                    description: "Session id to reset. Obtain from `list_sessions` or from a " +
                        "prior `ask_question` response (`result.session_id`).",
                },
            },
            required: ["session_id"],
