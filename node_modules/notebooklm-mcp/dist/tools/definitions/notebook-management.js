...
export const notebookManagementTools = [
    {
        name: "add_notebook",
        description: "Register a NotebookLM notebook in the local library so it can be " +
        ...
        inputSchema: {
            ...
            properties: {
                url: {
                    type: "string",
                    description: "NotebookLM share URL. Format: " +
    ...
    {
        name: "list_notebooks",
        description: "List every notebook in the local library with its metadata " +
    ...
    {
        name: "get_notebook",
        description: "Fetch full metadata for one notebook by id. Use to verify what's " +
    ...
    },
    {
        ...
        description: "Mark a notebook as the active default. After this, `ask_question`, " +
    ...
    },
    {
        ...
        description: "Patch metadata fields on an existing notebook. Pass `id` plus any " +
    ...
    },
    {
        ...
        description: "Remove a notebook from the local library. **Does NOT delete the " +
    ...
    },
    {
        ...
        description: "Search the library by free-text query — matches against `name`, " +
    ...
    },
    {
        ...
        description: "Aggregate statistics about the local notebook library: " +
