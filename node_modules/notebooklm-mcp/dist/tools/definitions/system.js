...
export const systemTools = [
    {
        name: "get_health",
        description: "Inspect server state. Returns:\n" +
    ...
    {
        name: "setup_auth",
        description: "Open a browser window for first-time Google login. Returns immediately " +
        ...
        inputSchema: {
            ...
            properties: {
                show_browser: {
                    type: "boolean",
                    description: "Show the browser window. Default: true (must be visible so the " +
                        "user can interact). For advanced control use `browser_options`.",
                },
                browser_options: {
                    type: "object",
                    description: "Advanced browser settings. Override visibility, timeout, or " +
    ...
    {
        name: "re_auth",
        description: "Switch to a different Google account or recover from broken auth. " +
    ...
    {
        name: "cleanup_data",
        description: "Two-phase deep cleanup of all server data on disk (auth state, " +
        ...
        inputSchema: {
            ...
            properties: {
                confirm: {
                    type: "boolean",
                    description: "false = preview only (default). true = actually delete after " +
                        "user reviewed the preview.",
                },
                preserve_library: {
                    type: "boolean",
                    description: "Keep notebook library.json while deleting everything else. " +
